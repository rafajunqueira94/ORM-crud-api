...
var controllers = require("../controllers/indexControllers.js");

var empresasControllers = require("../controllers/empresasControllers.js");

var cidadesControllers = require("../controllers/cidadesControllers.js");

var candidatosControllers = require("../controllers/candidatosControllers");

var cursosControllers = require("../controllers/cursosControllers");

var produtosControllers = require("../controllers/produtosControllers");

var telefonesControllers = require("../controllers/telefonesControllers"); // rota raiz


routes.get("/", controllers.indexRaiz); // rotas de cidades
...
routes.get("/cidades/find/:id", cidadesControllers.findByPk); // rotas de empresas
...
routes.get("/empresas/find/:id", empresasControllers.findByPk); // rotas de candidatos
...
routes.get("/candidatos/find/:id", candidatosControllers.findByPk); // rotas de cursos
...
routes.get("/cursos/find/:id", cursosControllers.findByPk); // rotas de produtos
...
routes.get("/produtos/find/:id", produtosControllers.findByPk); // rota produto ATIVO / INATIVO

routes.get("/produtos/ai/:id", produtosControllers.produtosAi); // rotas de telefones
